...
- Dependency updates:
  - `apollovm`: updated from ^0.1.25 to ^0.1.26

## 1.0.57

- Dependency updates:
  - `apollovm`: updated from ^0.1.24 to ^0.1.25
...
- Dependency updates:
  - Updated `apollovm` from ^0.1.20 to ^0.1.21.

## 1.0.49

- Dependency updates:
  - `apollovm`: updated from ^0.1.19 to ^0.1.20

## 1.0.48

- Dependency updates:
  - `apollovm`: updated from ^0.1.18 to ^0.1.19
...
- Dependency updates:
  - `apollovm`: updated from ^0.1.13 to ^0.1.14

## 1.0.43

- Dependency updates:
  - `apollovm`: updated from ^0.1.12 to ^0.1.13
